...
class BaseModel(nn.Module):
    ...
    def generate_graph(
        ...
        coord_diff = pos[row] - pos[col]  ### equivalent to distance_vectors in original code
        ...
        edge_dist = coord_diff.norm(dim = -1) + 1e-8
        edge_vec = coord_diff
        temp = None
        return (edge_index, edge_dist, edge_vec, temp, temp, temp)
